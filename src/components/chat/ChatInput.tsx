...
export const ChatInput = ({ onUpdate, onReset, waiting }: Props) => {
  ...
  return (
    <div className="border-t-2 border-t-blue-800 bg-blue-800 p-2">
      <div className="container mx-auto ">
        <div className=" flex ">
          <textarea
            className={clsx("w-full rounded-md bg-blue-50 p-2  text-black", {
              "opacity-50": waiting,
            })}
            placeholder="Ask furher questions..."
            value={prompt}
        ...
        <div className="my-2 flex items-center justify-between">
          <button
            className={clsx("rounded-md bg-blue-600 px-4 py-2 text-white", {
              "opacity-50": waiting,
            })}
            onClick={onReset}
            disabled={waiting}
